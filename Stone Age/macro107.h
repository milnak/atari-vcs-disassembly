...
VERSION_MACRO         = 107  ; unoffical version updated by Omegamatrix
...
;
; Latest Revisions...
; 1.07  02/SEP/2013     - added SAME PAGE BRANCH CHECK (John Payson)
;                       - added DIFFERENT PAGE BRANCH CHECK (Darrell Spice, Jr.)
...
;     sbcc,sbcs,sbne,sbeq,sbvs,sbvc,sbpl,sbmi  - stops compilation if page boundary is crossed
;   DIFFERENT PAGE BRANCH CHECK:
;     dbcc,dbcs,dbne,dbeq,dbvs,dbvc,dbpl,dbmi  - stops compilation if page boundary is not crossed
